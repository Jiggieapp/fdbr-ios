...
class BaseViewController: UIViewController {
    ...
    func setupNavigationBar(translucent translucent: Bool) {
        if translucent {
            ...
            self.navigationController?.navigationBar.backgroundColor = UIColor.whiteColor().colorWithAlphaComponent(0)
    ...
    func setupNavigationBar(title title: String, subtitle: String) {
        ...
        attributedString.addAttribute(NSFontAttributeName, value: UIFont.systemFontOfSize(16), range: titleRange)
        attributedString.addAttribute(NSFontAttributeName, value: UIFont.systemFontOfSize(13), range: subtitleRange)
    ...
    func setupLeftNavigationBar(withTitle title: String) {
        ...
        barButtonItem.setTitleTextAttributes([NSFontAttributeName : UIFont.boldSystemFontOfSize(13)],
                                             forState: .Normal)
